...
public class FormatTests {
  ...
  public void enumeratedProperlyWithArgs(String[] input, String[] expected, int start) {
	...
	/** 
	 * This method provides the needed arguments for {@link #enumeratedProperlyWithNoArgs(String[], String[])} test
  ...
  public static Stream<Arguments> toEnumerateNoArgs() {
	...
	/** 
	 * This method provides the needed arguments for {@link #enumeratedProperlyWithArgs(String[], String[], int)} test
	 * @return stream of arguments
	*/
