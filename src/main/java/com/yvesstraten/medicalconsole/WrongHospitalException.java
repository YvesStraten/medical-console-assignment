...
/**
 * This exception is thrown when this patient has not
 * yet visited a hospital and the hospital that the 
 * patient is to operated in not the same as the last 
 * visited hospital of the patient
